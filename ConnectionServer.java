...
class ConnectionServer implements Runnable { 
    ...
    public static final String WAIT_NAME_MSG = "Enter you name!\n";
    public static final String WAIT_AUTH_MSG = "Enter the symbol pls!\n"; 
    public static final String AUTH_DONE_MSG = "You may start bidding\n"; 
	...
	try { 
		...
		case WAIT_AUTH: 
			...
			clientSymbol = line;
			stockPrice = mainServer.getPrice(clientSymbol);
			outline = "The current cost of "+clientSymbol+" is "+stockPrice+"\n"+AUTH_DONE_MSG; 
		    }
		    else {
			outline = "-1\n"; 
		    }
		    ...
		    /*****************************/
		case AUTH_DONE: 
		    mainServer.postMSG(this.clientName + " bids " + line + " on " + this.clientSymbol);
		    outline = MSG_POSTED; 
		    break; 
		default: 
